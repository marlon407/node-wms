...
This is a application for building REST APIs in Node.js using ES6 and Express with Code Coverage and JWT Authentication. Helps you stay productive by following best practices. Follows [Airbnb's Javascript style guide](https://github.com/airbnb/javascript).
...
And also from [express-mongoose-es6-rest-api] ((https://github.com/KunalKapadia/express-mongoose-es6-rest-api))
